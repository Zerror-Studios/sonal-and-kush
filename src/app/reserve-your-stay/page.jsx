...
const rateRows = [
  ...
  { label: "Taxes:", value: "₹7,110" },
  { label: "Subtotal:", value: "₹46,610" },
  { label: "Service Fee (3.5%):", value: "₹1,631" },
];
...
const bookingSchema = z
  .object({
    checkIn: z.string().refine((v) => v >= DATE_MIN && v < DATE_MAX, {
      message: "Check-in must be between 21–23 September 2026",
    }),
    checkOut: z.string().refine((v) => v > DATE_MIN && v <= DATE_MAX, {
    ...
    return (
      <div className="min-h-screen COLOR_BG_RED flex items-center justify-center p-8">
        <div className="COLOR_BG_CREAM border border-[#e2d9c8] rounded-sm px-10 py-12 max-w-md w-full text-center shadow-[0_8px_48px_rgba(120,90,40,0.10)]">
          ...
          <h2 className=" Font_Q COLOR_TEXT_RED mb-10 max-sm:mb-6">
            Confirmed!
          </h2>
          <p className="text-sm Font_YV text-[#7a6a55] mb-6">
            Thank you for your booking at Sonal's Kushie. A confirmation will be
            sent to your email.
          </p>
          <div className="bg-[#f9f6f1] rounded-sm p-4 text-left space-y-1.5 mb-6">
            <p className="text-xs Font_YV text-[#7a6a55]">
              📅 {fmtDisplay(checkIn)} – {fmtDisplay(checkOut)} ({nights}{" "}
              nights)
            </p>
            <p className="text-xs Font_YV text-[#7a6a55]">
              🏨 {rooms} Room{rooms > 1 ? "s" : ""}
            </p>
            <p className="text-xs Font_YV COLOR_TEXT_RED font-semibold">
              💰 {formatINR(total)}
            </p>
          </div>
        ...
        <div className="h-fit max-lg:w-full mb-auto COLOR_TEXT_CREAM flex items-start sm:items-center justify-center p-4 sm:p-8">
          <div className="relative w-full max-w-sm sm:max-w-md COLOR_TEXT_CREAM">
            ...
            <div className="COLOR_BG_RED rounded-sm shadow-[0_4px_32px_rgba(120,90,40,0.08)] COLOR_TEXT_CREAM">
              ...
              <div className="px-5 sm:px-6 py-4 space-y-3">
                {rateRows.map(({ label, value }) => (
                  <div
                    key={label}
                    className="flex items-center justify-between gap-4 Font_YV"
                  >
                    <span className="text-xs sm:text-sm COLOR_TEXT_CREAM tracking-wide">
                      {label}
                    </span>
                    <span className="text-xs sm:text-sm COLOR_TEXT_CREAM tabular-nums font-medium">
                      {value}
                    </span>
                  </div>
                ))}
            ...
            <div className="mt-6 space-y-2.5">
              <ContactRow
                icon="email"
                text="sonalskushie@gmail.com"
                link="mailto:sonalskushie@gmail.com"
              />
              <ContactRow
                icon="phone"
                text="+91 93588 00614"
                link="https://wa.me/+919358800614"
              />
              {/* <ContactRow
                icon="phone"
                text="+91 93100 69102"
                link="https://wa.me/+919310069102"
              /> */}
            </div>
            ...
            >
                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      <div className="flex items-center justify-between border border-[#d8cdb8] bg-white px-3 py-2 rounded-sm">
                        ...
                        <span className="text-sm COLOR_TEXT_RED font-medium">
                          {field.value}
                        </span>
                        <button
                          type="button"
              ...
              <div className="mt-2 border border-[#e2d9c8] bg-[#f5f0e8] rounded-sm px-5 py-4">
                ...
                <div className="flex items-center justify-between mt-4">
                  <span className="text-sm tracking-widest text-[#7a6a55] uppercase">
                    Total:
                  </span>
                  <span
              ...
              <div className="mt-4 flex items-center justify-center gap-3">
                <span className="text-[10px] font-bold tracking-widest text-[#7a6a55] border border-[#d8cdb8] px-2 py-0.5 rounded-sm">
                  UPI
                </span>
                <span className="text-[11px] font-black italic text-[#1a1f6e] tracking-wider">
                  VISA
                </span>
                ...
                <span className="text-[10px] font-bold tracking-wider COLOR_TEXT_RED border border-[#d8cdb8] px-2 py-0.5 rounded-sm">
                  RuPay
                </span>
              </div>
              ...
              <div className="mt-6 flex items-center justify-center gap-4">
                ...
                <div className="flex gap-4">
                  <a
                    href="#"
                    className="text-xs text-[#7a6a55] hover:COLOR_TEXT_RED transition-colors tracking-wide underline underline-offset-2 decoration-[#d8cdb8]"
                  >
                    Cancellation Policy
                  </a>
...
function MetaRow({ label, value }) {
  return (
    <div className="flex flex-wrap items-baseline gap-x-2 gap-y-0.5 COLOR_TEXT_CREAM">
      ...
      <span className="text-sm sm:text-base COLOR_TEXT_CREAM Font_YV">
        {value}
      </span>
    </div>
  );
  ...
  return (
    <div className="flex items-center gap-3 Font_YV">
      <div className="w-7 h-7 rounded-full border border-[#e2d9c8] bg-[#faf7f2] COLOR_TEXT_CREAM flex items-center justify-center shrink-0">
        {icon === "email" ? (
          <svg
            className="w-3.5 h-3.5 COLOR_TEXT_RED"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          >
          ...
          >
            <path
              d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07A19.5 19.5 0 013.07 9.81 19.79 19.79 0 01.08 1.18 2 2 0 012.06 0h3a2 2 0 012 1.72c.127.96.361 1.903.7 2.81a2 2 0 01-.45 2.11L6.09 7.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0122 16.92z"
              strokeWidth="1.5"
            />
          </svg>
        )}
      ...
      <a
        href={link}
        className="text-xs hover:underline cursor-pointer sm:text-sm tracking-wide COLOR_TEXT_CREAM"
      >
        {text}
      </a>
    </div>
