        ...
        >
            ...
            <div className="w-fit max-w-[665px] contA6 h-fit flex flex-col gap-6 justify-center items-center">
              ...
              <div className="w-full max-w-[460px] flex flex-col contA6 justify-center items-center gap-6">
                <div className="text-[#395238] text-[18px] contA6 COLOR_TEXT_RED text-center Font_YV">
                  Planning to turn this wedding into a longer India journey?
                  You’re in the right place. India offers an incredible mix of
                  culture, landscapes, food, and heritage — and Udaipur is just
                  the beginning. Whether you’re arriving early or staying on
                  after the celebrations, there’s so much to discover.
                </div>
              </div>
              ...
              <span className=" w-full max-w-[460px] flex flex-col justify-center items-center text-center   Font_YV COLOR_TEXT_RED">
                If you’d like to plan a customized trip before or after the
                wedding, please contact our trusted travel partners.
                <div className="flex gap-2">
                  (Breakaway Travel)
                  <a
                    rel="stylesheet"
                    target="_blank"
                    href="https://www.break-away.in"
                ...
                <span className="mt-2 font-semibold ">
                  ...
                  <a
                    target="_blank"
                    href="https://wa.me/+919310007855"
                    className="select-none group cursor-pointer relative"
                  >
                    {" "}
                    +91 93100 07855
                  ...
                  <a
                    target="_blank"
                    href="mailto:bindu@break-away.in"
                    className="select-none group cursor-pointer relative"
                  >
                    bindu@break-away.in
                    <div className=" absolute bottom-0 left-0 h-[1px] COLOR_BG_RED transition-all duration-150 ease-out w-0 group-hover:w-full"></div>
          ...
          <div className="w-[50vw] h-screen  flex justify-center items-center  ">
            <div className="w-fit max-w-[665px] contA6 h-fit flex flex-col gap-6 justify-center items-center">
              ...
              <div className="w-full max-w-[460px] flex flex-col contA6 justify-center items-center gap-6">
                <div className="text-[#395238] text-[18px] contA6 COLOR_TEXT_RED text-center Font_YV">
                  The Pink City blends royal heritage with vibrant bazaars and
                  stunning palaces. Highlights: Amber Fort, City Palace, Hawa
                  Mahal, block-print & gemstone shopping.
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="w-fit max-w-[665px] contA6 h-fit flex flex-col gap-6 justify-center items-center">
              ...
              <div className="w-full max-w-[460px] flex flex-col contA6 justify-center items-center gap-6">
                <div className="text-[#395238] text-[18px] contA6 COLOR_TEXT_RED text-center Font_YV">
                  ...
                  Highlights: Mehrangarh Fort, old city walks, boutique heritage
                  stays.
                </div>
              </div>
            </div>
          ...
          <div className=" animate_child w-[50vw] h-screen  flex justify-center items-center  ">
            <div className="w-fit max-w-[665px] contA6 h-fit flex flex-col gap-6 justify-center items-center">
              ...
              <div className="w-full max-w-[460px] flex flex-col contA6 justify-center items-center gap-6">
                <div className="text-[#395238] text-[18px] contA6 COLOR_TEXT_RED text-center Font_YV">
                  A dynamic mix of old-world charm and modern India. Highlights:
                  Old Delhi food trails, Humayun’s Tomb, Qutub Minar, luxury
                  dining & shopping.
                </div>
              </div>
            </div>
          ...
          <div className="animate_child w-[50vw] h-screen  flex justify-center items-center  ">
            <div className="w-fit max-w-[665px] contA6 h-fit flex flex-col gap-6 justify-center items-center">
              ...
              <div className="w-full max-w-[460px] flex flex-col contA6 justify-center items-center gap-6">
                <div className="text-[#395238] text-[18px] contA6 COLOR_TEXT_RED text-center Font_YV">
                  Home to one of the world’s most iconic monuments. Highlights:
            ...
            <div className="w-fit max-w-[665px] contA6 h-fit flex flex-col gap-6 justify-center items-center">
              ...
              <div className="w-full max-w-[460px] flex flex-col contA6 justify-center items-center gap-6">
                <div className="text-[#395238] text-[18px] contA6 COLOR_TEXT_RED text-center Font_YV">
                  ...
                  Highlights: Gateway of India, art deco architecture, nightlife
                  & restaurants.
                </div>
              </div>
            </div>
          ...
          <div className="w-[50vw] h-screen  flex justify-center items-center  ">
            <div className="w-fit max-w-[665px] contA6 h-fit flex flex-col gap-6 justify-center items-center">
              ...
              <div className="w-full max-w-[460px] flex flex-col contA6 justify-center items-center gap-6">
                <div className="text-[#395238] text-[18px] contA6 COLOR_TEXT_RED text-center Font_YV">
                  For a relaxed beach break after the wedding. Highlights: Beach
                  clubs, Portuguese architecture, sunset views.
                </div>
              </div>
            </div>
          </div>
          ...
          <div className=" animate_child w-[50vw] h-screen  flex justify-center items-center  ">
            <div className="w-fit max-w-[665px] contA6 h-fit flex flex-col gap-6 justify-center items-center">
              ...
              <div className="w-full max-w-[460px] flex flex-col contA6 justify-center items-center gap-6">
                <div className="text-[#395238] text-[18px] contA6 COLOR_TEXT_RED text-center Font_YV">
                  Lush, serene, and perfect for unwinding. Highlights: Backwater
                  houseboats, Ayurveda retreats, tea plantations.
                </div>
              </div>
            </div>
          </div>
          ...
          <div className=" animate_child w-[50vw] h-screen  flex justify-center items-center  ">
            <div className="w-fit max-w-[665px] contA6 h-fit flex flex-col gap-6 justify-center items-center">
              ...
              <div className="w-full max-w-[460px] flex flex-col contA6 justify-center items-center gap-6">
                <div className="text-[#395238] text-[18px] contA6 COLOR_TEXT_RED text-center Font_YV">
                  Often called paradise on earth, known for its breathtaking
                  landscapes. Highlights: Srinagar houseboats, Dal Lake,
                  Gulmarg.
                </div>
              </div>
            </div>
          ...
          <div className="animate_child w-[50vw] h-screen  flex justify-center items-center  ">
            <div className="w-fit max-w-[665px] contA6 h-fit flex flex-col gap-6 justify-center items-center">
              ...
              <div className="w-full max-w-[460px] flex flex-col contA6 justify-center items-center gap-6">
                <div className="text-[#395238] text-[18px] contA6 COLOR_TEXT_RED text-center Font_YV">
                  Charming hill towns and mountain retreats. Highlights: Shimla,
                  Manali, Dharamshala.
                </div>
              </div>
            </div>
          ...
          <div className=" animate_child w-[50vw] h-screen  flex justify-center items-center  ">
            <div className="w-fit max-w-[665px] contA6 h-fit flex flex-col gap-6 justify-center items-center">
              ...
              <div className="w-full max-w-[460px] flex flex-col contA6 justify-center items-center gap-6">
                <div className="text-[#395238] text-[18px] contA6 COLOR_TEXT_RED text-center Font_YV">
                  A mix of spirituality and scenic beauty. Highlights:
                  Rishikesh, Mussoorie, Jim Corbett.
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="w-[50vw] h-screen  flex justify-center items-center  ">
            <div className="w-fit max-w-[665px] contA6 h-fit flex flex-col gap-6 justify-center items-center">
              ...
              <div className="w-full max-w-[460px] flex flex-col contA6 justify-center items-center gap-6">
                <div className="text-[#395238] text-[18px] contA6 COLOR_TEXT_RED text-center Font_YV">
                  Crystal-clear waters and pristine beaches. Highlights:
                  Radhanagar Beach, scuba diving, private island stays.
                </div>
              </div>
            </div>
          </div>
          ...
          <div className=" animate_child w-[50vw] h-screen  flex justify-center items-center  ">
            <div className="w-fit max-w-[665px] contA6 h-fit flex flex-col gap-6 justify-center items-center">
              ...
              <div className="w-full max-w-[460px] flex flex-col contA6 justify-center items-center gap-6">
                <div className="text-[#395238] text-[18px] contA6 COLOR_TEXT_RED text-center Font_YV">
                  Remote, untouched, and incredibly serene. Highlights:
                  Turquoise lagoons, coral reefs, barefoot luxury.
                </div>
              </div>
            </div>
          </div>
          ...
          <div className=" animate_child w-[50vw] h-screen  flex justify-center items-center  ">
            <div className="w-fit max-w-[665px] contA6 h-fit flex flex-col gap-6 justify-center items-center">
              ...
              <div className="w-full max-w-[460px] flex flex-col contA6 justify-center items-center gap-6">
                <div className="text-[#395238] text-[18px] contA6 COLOR_TEXT_RED text-center Font_YV">
                  A hidden gem of lush landscapes, rich cultures, and offbeat
                  experiences. Highlights: Assam (tea estates, Kaziranga),
                  Meghalaya (living root bridges), Sikkim & Arunachal (Himalayan
                  views, monasteries).
                </div>
              </div>
            </div>
          ...
          <div className="animate_child w-[50vw] h-screen  flex justify-center items-center  ">
            <div className="w-fit max-w-[665px] contA6 h-fit flex flex-col gap-6 justify-center items-center">
              ...
              <div className="w-full max-w-[460px] flex flex-col contA6 justify-center items-center gap-6">
                <div className="text-[#395238] text-[18px] contA6 COLOR_TEXT_RED text-center Font_YV">
                  A peaceful Himalayan kingdom rooted in mindfulness and natural
                  beauty. Highlights: Tiger’s Nest Monastery, Paro Valley.
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="w-fit max-w-[665px] contA6 h-fit flex flex-col gap-6 justify-center items-center">
              ...
              <div className="w-full max-w-[460px] flex flex-col contA6 justify-center items-center gap-6">
                <div className="text-[#395238] text-[18px] contA6 COLOR_TEXT_RED text-center Font_YV">
                  ...
                  Highlights: Kathmandu, Pokhara, Everest views.
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="w-fit max-w-[665px] contA6 h-fit flex flex-col gap-6 justify-center items-center">
              ...
              <div className="w-full max-w-[460px] flex flex-col contA6 justify-center items-center gap-6">
                <div className="text-[#395238] text-[18px] contA6 COLOR_TEXT_RED text-center Font_YV">
                  ...
                  Highlights: Tea plantations, beaches, wildlife safaris.
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="w-full h-fit p-5 flex flex-col gap-5  ">
          ...
          <div className="w-fit max-w-[665px]  contA6 h-fit flex flex-col gap-6 mt-30 justify-center m-auto items-center">
            ...
            <div className="w-fit max-w-[460px] flex flex-col contA6 justify-center items-center gap-6">
              <div className="text-[#395238] text-[18px] contA6 COLOR_TEXT_RED text-center Font_YV flex">
                ...
                You’re in the right place. India offers an incredible mix of
                culture, landscapes, food, and heritage — and Udaipur is just
                the beginning. Whether you’re arriving early or staying on after
                the celebrations, there’s so much to discover.
              </div>
            </div>
          ...
          <div className="w-fit max-w-[665px] contA6 h-fit flex flex-col gap-6 justify-center m-auto mt-20 items-center">
            ...
            <div className="w-full max-w-[460px] flex flex-col contA6 justify-center items-center gap-6">
              <div className="text-[#395238] text-[18px] contA6 COLOR_TEXT_RED text-center Font_YV">
                Often called paradise on earth, known for its breathtaking
                landscapes. Highlights: Srinagar houseboats, Dal Lake, Gulmarg.
              </div>
            </div>
          </div>
          ...
          <div className="w-fit max-w-[665px] contA6 h-fit flex flex-col gap-6 m-auto justify-center mt-20 items-center">
            ...
            <div className="w-full max-w-[460px] flex flex-col contA6 justify-center items-center gap-6">
              <div className="text-[#395238] text-[18px] contA6 COLOR_TEXT_RED text-center Font_YV">
                A mix of spirituality and scenic beauty. Highlights: Rishikesh,
          ...
          <div className="w-fit max-w-[665px] contA6 h-fit flex flex-col gap-6 justify-center m-auto mt-20 items-center">
            ...
            <div className="w-full max-w-[460px] flex flex-col contA6 justify-center items-center gap-6">
              <div className="text-[#395238] text-[18px] contA6 COLOR_TEXT_RED text-center Font_YV">
                Remote, untouched, and incredibly serene. Highlights: Turquoise
                lagoons, coral reefs, barefoot luxury.
              </div>
            </div>
          </div>
          ...
          <div className="w-full aspect-1/1 overflow-hidden ">
            <img
              src={`/imgs/explorNewImg/pales.webp`}
              className="w-full h-full object-cover  object-center"
              alt="img"
            />
          </div>
          ...
          <div className="w-fit max-w-[665px] contA6 h-fit flex flex-col gap-6 m-auto justify-center mt-20 items-center">
            ...
            <div className="w-full max-w-[460px] flex flex-col contA6 justify-center items-center gap-6">
              <div className="text-[#395238] text-[18px] contA6 COLOR_TEXT_RED text-center Font_YV">
                Compact, diverse, and ideal for a relaxed extension. Highlights:
                Tea plantations, beaches, wildlife safaris.
              </div>
            </div>
          </div>
